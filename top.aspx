...
<head runat="server">
    <title></title>
    <link href="/Content/skin/css/base.css" rel="stylesheet" type="text/css"/>
...
{
  text-align:center;
	background:url(/Content/skin/images/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
.rmain {
  padding-left:10px;
  /* background:url(/Content/skin/images/toprightbg.gif) no-repeat; */
}
</style>
</head>
<body>
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="/Content/skin/images/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="/Content/skin/images/logo.gif" /></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username"></span>，欢迎登陆！
        	[<a href="http://www.114118.org" target="_blank">网站主页</a>]        	
        	[<a onclick="signout();">注销退出</a>]&nbsp;
      </td>
      </tr>      
    </table>
    </td>
