...
<body>
<form id="form1" method="post" action="/admin/UpdateParmer">
<%
    Parmer p = ViewData["p"] as Parmer;
    var pname = "";
    var pvalue = "";
    var pdesc = "";
    var id="";
           ...
           <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
            <tr style="height:25px;">
              ...
              <td height="20" colspan="3">
                <input id="pname" name="pname" readonly="readonly" value="<%:pname %>" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="80">参数值</td>
              <td height="20" colspan="3">
                <textarea id="pvalue" name="pvalue" cols="3" rows="2" style="width:450px; height:80px;" class="ltb"><%:pvalue %></textarea>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="80">参数描述</td>
              <td colspan="3">
               <textarea id="pdesc" name="pdesc" cols="3" rows="2" style="width:300px; height:80px;"><%:pdesc %></textarea>
              </td>
            </tr>
          </table>
         </td>
