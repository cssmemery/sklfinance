...
<body>
<form id="form1" method="post" action="/admin/AddQiushi">
           ...
           <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
            <tr style="height:25px;">
              ...
              <td height="20" colspan="3">
                <input id="title" name="title" type="text" style="width:180px;" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">内容</td>
              <td height="20" colspan="3">
                <textarea id="qcontent" name="qcontent" class="ltb" rows="2" style="width:600px; height:100px;"></textarea>
              </td>
            </tr>
          </table>
         </td>
