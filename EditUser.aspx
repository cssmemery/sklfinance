...
<body>
<form id="form1" method="post" action="/admin/UpdateUser">
<%
    User user = ViewData["user"] as User;
    var useruser = user.useruser;
           ...
           <table width="70%" border="0" cellpadding="0" cellspacing="0"> 
            <tr style="height:25px;">
              ...
              <td height="20" colspan="3">
                <input id="useruser" readonly="readonly" name="useruser" value="<%:useruser %>" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">用户名称</td>
              <td height="20" colspan="3">
                <input id="username" name="username" value="<%:username %>" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">登录密码</td>
              <td colspan="3">
                <input id="pwd" name="pwd" type="password" value="<%:pwd %>" class="ltb"/>
              </td>
            </tr>
          </table>
         </td>
