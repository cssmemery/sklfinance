...
<body>
<form id="form1" method="post" action="/admin/AddLink">
           ...
           <table width="70%" border="0" cellpadding="0" cellspacing="0"> 
            <tr style="height:25px;">
              ...
              <td height="20" colspan="3">
                <input id="webname" name="webname" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
            ...
            <tr style="height:25px;">
              <td width="142">联系人</td>
              <td colspan="3">
                <input id="lxr" name="lxr" type="text" class="ltb"/>
              </td>
            </tr>
            <tr>
              <td width="142">联系电话</td>
              <td height="20" colspan="3">
                <input id="phone" name="phone" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">邮箱地址</td>
              <td colspan="3">
                <input id="email" name="email" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">序号</td>
              <td colspan="3">
                <input id="sortid" name="sortid" type="text" class="ltb"/>
              </td>
            </tr>
          </table>
         </td>
