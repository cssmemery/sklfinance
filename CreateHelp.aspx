...
<body>
<form id="form1" method="post" action="/admin/AddHelp">
           ...
           <tr style="height:25px;">
              ...
              <td height="20" colspan="3">
                <select id="item" name="item" class="ltb">
                    ...
                    <option value="关于奖金">关于奖金</option>
                    <option value="其它帮助">其它帮助</option>
                </select>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">序号</td>
              <td height="20" colspan="3">
                <input id="sxh" name="sxh" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">标题</td>
              <td height="20" colspan="3">
                <input id="title" name="title" style="width:200px;" type="text" class="ltb"/>
              </td>
            </tr>
            <tr style="height:25px;">
              <td width="142">内容</td>
              <td colspan="3">
                <textarea id="hcontent" rows="2" cols="2" name="hcontent" style="width:700px;height:300px;"></textarea>
              </td>
            </tr>
          </table>
         </td>
